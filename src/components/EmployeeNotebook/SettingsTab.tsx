                    ...
                    <div className="space-y-4">
                        <div>
                            <div className="flex items-start">
                                ...
                                <span className="text-sm text-gray-900 ml-4">{settings.status.employee_type}</span>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                <div className="flex items-start">
                                    ...
                                    <span className="text-sm text-gray-900 ml-4">{settings.status.related_user}</span>
                                </div>
                        ...
                        <div>
                            <div className="flex items-start">
                                ...
                                <div className="ml-4 flex items-center">
                                    <span className="text-sm text-gray-900">{settings.application_settings.hourly_cost}.00</span>
                    ...
                    <div className="space-y-4">
                        <div>
                            <div className="flex items-start">
                                ...
                                <span className="text-sm text-gray-900 ml-4">{settings.attendance_point_of_sale.pin_code}</span>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                <div className="flex items-start">
                                    ...
                                    <span className="text-sm text-gray-900 ml-4">{settings.attendance_point_of_sale.badge_id}</span>
                                </div>
                                <button className="text-teal-600 hover:text-teal-700 text-sm font-medium">
                                    Generate
                                </button>
